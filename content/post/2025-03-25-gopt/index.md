...
<style>
  ...
  .table-container table {
    margin: 1rem 0;
    border-collapse: collapse;  /* 补充分号 */
    box-shadow: 0 0 10px rgba(0,0,0,0.1);  /* 修正参数 */
    white-space: nowrap;  /* 修正拼写 */
  }
...
<div class="markdown-table-wrapper">
  ...
  <p style="text-align:center;font-size:0.9em">Tab.1 The LDBC<sub>100</sub> DataSet</p>
</div>
